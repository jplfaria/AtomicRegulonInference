package AtomicRegulonInference::AtomicRegulonInferenceServer;
...
sub call_method {
    ...
    my $ctx = AtomicRegulonInference::AtomicRegulonInferenceServerContext->new($self->{loggers}->{userlog},
    ...
    # Service AtomicRegulonInference does not require authentication.
    ...
    my @result;
    {
        ...
        my $stderr = AtomicRegulonInference::AtomicRegulonInferenceServerStderrWrapper->new($ctx, $get_time);
        $ctx->stderr($stderr);
...
sub get_method
{
    ...
    {
	$self->exception('NoSuchMethod',
			 "'$method' is not a valid method in service AtomicRegulonInference.");
    }
...
package AtomicRegulonInference::AtomicRegulonInferenceServerContext;

use strict;

=head1 NAME

AtomicRegulonInference::AtomicRegulonInferenceServerContext
...
package AtomicRegulonInference::AtomicRegulonInferenceServerStderrWrapper;
...
unless (caller) {
    ...
    my $server = AtomicRegulonInference::AtomicRegulonInferenceServer->new(
