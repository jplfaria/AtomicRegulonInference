SERVICE = atomicreguloninference
SERVICE_CAPS = AtomicRegulonInference
SPEC_FILE = AtomicRegulonInference.spec
URL = https://kbase.us/services/atomicreguloninference
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
